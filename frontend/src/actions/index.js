...
export const fetchPostByID = (postID) => dispatch =>{
	ReadableAPI.fetchPostByID(postID)
	.then(post => dispatch(receivePostsByID(post)))
}
...
export const votePost = (postID, data) => dispatch =>{
	ReadableAPI.votePost(postID, data)
	.then(post => dispatch(votePostSuccess(post.id, data.option)))
}
...
export const editPost = (postID, data) => dispatch =>{
	ReadableAPI.editPost(postID, data)
...
export const voteComment = (commentID, data) => dispatch => {
	ReadableAPI.voteComment(commentID, data)
	.then(comment => dispatch(voteCommentSuccess(comment.id, data.option)))
}
...
export const editComment = (commentID, data) => dispatch =>{
	ReadableAPI.editComment(commentID, data)
	.then(comment => dispatch(editCommentSuccess(comment.id, data.body)))
}
